...
export const financialRules: FinancialRule[] = [
  ...
  {
    id: 21,
    title: { en: 'Rule of 72', ru: 'Правило 72', uz: '72 qoidasi' },
    category: 'Investing',
    isPro: true,
    shortDescription: { en: 'Estimate years to double by dividing 72 by the annual return rate.', ru: 'Приблизительный расчёт лет до удвоения: 72 ÷ годовая доходность.', uz: 'Investitsiya ikki baravar bo‘lishini 72 ni daromadlilikka bo‘lish orqali hisoblang.' },
    fullExplanation: { en: 'A quick heuristic: divide 72 by the expected annual return (percent) to estimate how many years it may take an investment to double. This is illustrative and not an exact guarantee of returns.', ru: 'Быстрый эвристический приём: разделите 72 на ожидаемую годовую доходность (в процентах), чтобы получить приблизительный срок удвоения инвестиций. Это иллюстрация, а не гарантия доходности.', uz: 'Tezkor hisob: 72 ni kutilayotgan yillik daromadlilikka (foizlarda) bo‘ling — natija investitsiyaning necha yilda ikki baravar bo‘lishini taxmin qiladi. Bu aniq kafolat emas.' },
    example: { en: 'At 8% annual return: 72 / 8 ≈ 9 years.', ru: 'При доходности 8%: 72 / 8 ≈ 9 лет.', uz: '8% yillik daromadlilikda: 72 / 8 ≈ 9 yil.' },
    whyItMatters: { en: 'It gives a quick, rough sense of time needed for compounding to double your money.', ru: 'Это даёт приближённое представление о времени, необходимом для удвоения капитала.', uz: 'Bu pulingizni ikki baravar qilish uchun zarur vaqtni taxminan ko‘rsatadi.' },
    source: { en: 'Investor.gov — Rule of 72', ru: 'Investor.gov — правило 72', uz: 'Investor.gov — 72 qoidasi' },
    formula: { en: 'Years to double ≈ 72 ÷ annual return (%)', ru: 'Лет до удвоения ≈ 72 ÷ годовая доходность (%)', uz: 'Ikki baravar bo‘lish uchun yil ≈ 72 ÷ yillik daromadlilik (%)' },
    interactiveAction: 'compound-growth',
    teaser: { en: 'Estimate how long it takes to double an investment.', ru: 'Приблизительно определите срок удвоения инвестиций.', uz: 'Investitsiyaning ikki baravar bo‘lish vaqtini taxmin qiling.' }
  },
  {
    id: 22,
    title: { en: 'Watch Investment Fees', ru: 'Следите за инвестиционными комиссиями', uz: 'Investitsiya komissiyalariga e’tibor bering' },
    category: 'Fees',
    isPro: true,
    shortDescription: { en: 'Small annual fees can reduce long-term returns—compare fee scenarios before investing.', ru: 'Небольшие комиссии уменьшают долгосрочную доходность — сравните варианты комиссий.', uz: 'Kichik yillik komissiyalar uzoq muddatli daromadni kamaytirishi mumkin — variantlarni solishtiring.' },
    fullExplanation: { en: 'Even fractions of a percent compound over years. Before choosing a fund or service, check the annual fee and model how it affects long-term value compared with lower-fee alternatives.', ru: 'Даже доли процента накапливаются со временем. Перед выбором фонда или сервиса изучите годовую комиссию и смоделируйте её влияние на долгосрочную стоимость по сравнению с более низкими комиссиями.', uz: 'Hatto foizning kichik qismi ham yillar davomida yig‘iladi. Fond yoki xizmat tanlashdan oldin yillik komissiyani tekshiring va uning uzoq muddatli ta’sirini hisoblang.' },
    example: { en: 'Example: $100,000 at 4% for 20 years → 0.25% ≈ $208,000; 0.50% ≈ $198,000; 1.00% ≈ $179,000.', ru: 'Пример: $100,000 при 4% за 20 лет → 0.25% ≈ $208,000; 0.50% ≈ $198,000; 1.00% ≈ $179,000.', uz: 'Misol: $100,000, 4% va 20 yil → 0.25% ≈ $208,000; 0.50% ≈ $198,000; 1.00% ≈ $179,000.' },
    whyItMatters: { en: 'Over decades, fees can materially reduce the final portfolio value.', ru: 'За десятилетия комиссии могут существенно снизить итоговую сумму портфеля.', uz: 'O‘n yillar davomida komissiyalar yakuniy qiymatga sezilarli ta’sir ko‘rsatishi mumkin.' },
    source: { en: 'Investor.gov — How Fees and Expenses Affect Your Investment Portfolio', ru: 'Investor.gov — Как комиссии влияют на инвестиционный портфель', uz: 'Investor.gov — Komissiyalar va xarajatlar investitsiya portfelingizga qanday ta’sir qiladi' },
    formula: { en: 'Compare final values with and without fees over the time horizon', ru: 'Сравните итоговые суммы с комиссией и без неё за выбранный период', uz: 'Tanlangan davr uchun komissiyali va komissiyasiz yakuniy summalarni solishtiring' },
    interactiveAction: 'investment-fees',
    teaser: { en: 'See how different annual fees change long-term value.', ru: 'Посмотрите, как разные комиссии меняют долгосрочный итог.', uz: 'Turli yillik komissiyalar uzoq muddatli natijaga qanday ta’sir qilishini ko‘ring.' }
  },
  {
    id: 23,
    title: { en: 'Give Every Extra Sum a Job', ru: 'Назначьте задачу каждой свободной сумме', uz: 'Har bir ortiqcha summaga vazifa bering' },
    category: 'Habits',
    isPro: true,
    shortDescription: { en: 'After reserves, assign leftover money to specific goals, investing, or planned spending.', ru: 'После резерва направляйте оставшуюся сумму на конкретные цели, инвестиции или плановые расходы.', uz: 'Zaxiralar yaratilgandan so‘ng qolgan pulni maqsadlarga, investitsiyaga yoki rejalashtirilgan xarajatlarga yo‘naltiring.' },
    fullExplanation: { en: 'Giving each extra amount a purpose reduces drift and makes progress measurable. Use goals or dedicated savings buckets to track where spare cash is going.', ru: 'Назначение конкретной цели каждой избыточной суммы уменьшает распыление и делает прогресс измеримым. Используйте цели или отдельные фонды для отслеживания.', uz: 'Har bir ortiqcha summaga maqsad belgilash tarqalishni kamaytiradi va progressni o‘lchash imkonini beradi. Maqsadlar yoki alohida fondlardan foydalaning.' },
    example: { en: 'After emergency savings, direct extra income to: Goal A, Long-term investing, Planned spending.', ru: 'После фонда на ЧП направьте лишние средства: Цель A, долгосрочные инвестиции, запланированные траты.', uz: 'Favqulodda jamg‘armadan so‘ng ortiqcha daromadni mos ravishda: Maqsad A, uzoq muddatli investitsiya, rejalashtirilgan xarajatlarga yo‘naltiring.' },
    whyItMatters: { en: 'It keeps money working toward priorities instead of leaking into miscellaneous spending.', ru: 'Так деньги работают на приоритеты, а не теряются на различные мелочи.', uz: 'Bu pulni asosiy maqsadlarga yo‘naltirishga yordam beradi, tasodifiy sarfga ketishining oldini oladi.' },
    source: { en: 'Practical money management guidance', ru: 'Практические рекомендации по управлению деньгами', uz: 'Amaliy pul boshqaruvi bo’yicha ko‘rsatma' },
    formula: { en: 'Allocate surplus → goals/investment/planned spend', ru: 'Распределите избыток на цели/инвестиции/плановые траты', uz: 'Ortgan summani maqsadlar/investitsiya/rejalashtirilgan xarajatlarga ajrating' },
    interactiveAction: 'goal-completion',
    teaser: { en: 'Assign spare cash to goals or investing—don’t leave it unallocated.', ru: 'Назначьте лишние деньги целям или инвестициям и не оставляйте без адреса.', uz: 'Qo‘shimcha pulni maqsadlarga yoki investitsiyaga yo‘naltiring, belgilamaslikka yo‘l qo‘ymang.' }
  },
  {
    id: 24,
    title: { en: 'Review Your Portfolio Every 6–12 Months', ru: 'Проверяйте портфель каждые 6–12 месяцев', uz: 'Portfelni 6–12 oyda bir tekshiring' },
    category: 'Review',
    isPro: true,
    shortDescription: { en: 'Check allocation roughly every 6–12 months instead of reacting to each market move.', ru: 'Проверяйте распределение примерно каждые 6–12 месяцев, а не на каждое движение рынка.', uz: 'Bozordagi har bir o‘zgarishga emas, taxminan 6–12 oyda portfel taqsimotini tekshiring.' },
    fullExplanation: { en: 'Periodic reviews help you decide if rebalancing is needed without overtrading. Input target and current percentages to see the gap and whether adjustment may be appropriate.', ru: 'Периодические проверки помогают решить, нужен ли ребаланс, без лишней торговли. Введите целевые и текущие проценты, чтобы увидеть разницу.', uz: 'Muntazam tekshiruvlar rebalans zarurligini aniqlashga yordam beradi. Maqsad va joriy foizlarni kiriting va farqni ko‘ring.' },
    example: { en: 'Target: 60% stocks / 40% bonds. Current: 70% stocks / 30% bonds. Difference: 10% stock overweight.', ru: 'Цель: 60% акции / 40% облигации. Текущее: 70% акции / 30% облигации. Разница: 10% перекос в акциях.', uz: 'Maqsad: 60% aksiyalar / 40% obligatsiyalar. Joriy: 70% aksiyalar / 30% obligatsiyalar. Farq: aksiyalarda 10% ortiqcha.' },
    whyItMatters: { en: 'It keeps your portfolio aligned with goals without reacting to short-term volatility.', ru: 'Это помогает сохранять соответствие целям, не реагируя на краткосрочную волатильность.', uz: 'Bu portfelingizni maqsadga mos holda saqlashga yordam beradi va qisqa muddatli o‘zgarishlarga reaksiyani kamaytiradi.' },
    source: { en: 'Investor.gov / FINRA — rebalancing guidance', ru: 'Investor.gov / FINRA — рекомендации по ребалансировке', uz: 'Investor.gov / FINRA — rebalans bo‘yicha ko‘rsatma' },
    formula: { en: 'Difference = current% − target% (per asset)', ru: 'Разница = текущее% − целевое% (для каждого актива)', uz: 'Farq = joriy% − maqsad% (har aktiv uchun)' },
    interactiveAction: 'portfolio-concentration',
    teaser: { en: 'Compare target vs current allocation to see where rebalancing may be needed.', ru: 'Сравните целевое и текущее распределение, чтобы понять, где нужен ребаланс.', uz: 'Qayerda rebalans kerakligini ko‘rish uchun maqsad va joriy taqsimotni taqqoslang.' }
  },
  {
    id: 25,
    title: { en: 'Invest Regularly Instead of Trying to Time the Market', ru: 'Инвестируйте регулярно, а не пытайтесь угадать рынок', uz: 'Bozorni vaqtini o‘lchashga harakat qilish o‘rniga muntazam investitsiya qiling' },
    category: 'Investing',
    isPro: true,
    shortDescription: { en: 'Invest equal or similar amounts at regular intervals — dollar-cost averaging (DCA).', ru: 'Инвестируйте равные суммы через регулярные интервалы — стратегия доллар-стоимости (DCA).', uz: 'Muntazam intervallarda teng yoki yaqin summalarni investitsiya qiling — Dollar-Cost Averaging (DCA).' },
    fullExplanation: { en: 'Regular investing can reduce the risk of buying at a single high point. This educational example demonstrates the DCA idea; it does not guarantee better returns.', ru: 'Регулярные взносы снижают риск покупки в один дорогой момент. Это образовательный пример идеи DCA, а не гарантия лучшей доходности.', uz: 'Muntazam investitsiyalar bitta yuqori nuqtada sotib olish xatarini kamaytiradi. Bu DCA g‘oyasining ta’limiy misoli, kafolat emas.' },
    example: { en: 'Strategy name: Dollar-Cost Averaging (DCA). Invest fixed amounts monthly regardless of price.', ru: 'Название стратегии: Dollar-Cost Averaging (DCA). Инвестируйте фиксированные суммы ежемесячно независимо от цены.', uz: 'Strategiya nomi: Dollar-Cost Averaging (DCA). Narxdan qat’i nazar, har oy belgilangan summani investitsiya qiling.' },
    whyItMatters: { en: 'It encourages disciplined investing and may reduce timing risk.', ru: 'Это поощряет дисциплинированное инвестирование и может снизить риск тайминга.', uz: 'Bu intizomli investitsiyani rag‘batlantiradi va vaqtni aniqlash xatarini kamaytirishi mumkin.' },
    source: { en: 'FINRA', ru: 'FINRA', uz: 'FINRA' },
    formula: { en: 'Regular contribution = fixed amount × number of periods', ru: 'Регулярный вклад = фиксированная сумма × число периодов', uz: 'Muntazam badal = belgilangan summa × davrlar soni' },
    interactiveAction: 'compound-growth',
    teaser: { en: 'Plan regular contributions and compare outcomes with lump-sum investing.', ru: 'Планируйте регулярные взносы и сравните с разовым инвестированием.', uz: 'Muntazam badallarni rejalashtiring va yakka boshlang‘ich sarmoyaga solishtiring.' }
  },
  {
    id: 26,
    title: { en: 'Pay More Than the Minimum on Expensive Debt', ru: 'Платите больше минимума по дорогому долгу', uz: 'Qimmat qarz bo‘yicha minimaldan ko‘proq to‘lang' },
    category: 'Debt',
    isPro: true,
    shortDescription: { en: 'Paying extra on high-interest debt reduces total interest and shortens repayment.', ru: 'Доплаты по долговым обязательствам с высокой ставкой сокращают общие проценты и срок погашения.', uz: 'Yuqori foizli qarzga qo‘shimcha to‘lov umumiy foizni kamaytiradi va muddatni qisqartiradi.' },
    fullExplanation: { en: 'Paying more than the minimum on expensive debt lowers overall interest and accelerates payoff. This is educational, not personalized advice.', ru: 'Платежи выше минимума снижают общую сумму процентов и ускоряют погашение. Это образовательная информация, не персональный совет.', uz: 'Qimmat qarz bo‘yicha minimal to‘lovdan ko‘proq to‘lash umumiy foiz miqdorini kamaytiradi va qarzni tezroq yopadi. Bu shaxsiy maslahat emas.' },
    example: { en: 'CFPB: $1,000 at 14% APR → $20/month ≈ 110 months & ~$700 interest; $50/month ≈ 23 months & ~$150 interest.', ru: 'CFPB: $1,000 при 14% → $20/мес ≈ 110 мес и ~$700 процентов; $50/мес ≈ 23 мес и ~$150 процентов.', uz: 'CFPB: $1,000, 14% yillik → $20/oy ≈ 110 oy va ~$700 foiz; $50/oy ≈ 23 oy va ~$150 foiz.' },
    whyItMatters: { en: 'Even modest extra payments can greatly reduce interest costs over time.', ru: 'Даже небольшие дополнительные платежи могут значительно снизить расходы на проценты.', uz: 'Hatto kichik qo‘shimcha to‘lovlar ham vaqt o‘tishi bilan foiz xarajatlarini kamaytiradi.' },
    source: { en: 'Consumer Financial Protection Bureau', ru: 'Consumer Financial Protection Bureau', uz: 'Consumer Financial Protection Bureau' },
    formula: { en: 'Extra payment reduces principal → lower future interest', ru: 'Дополнительный платёж уменьшает основной долг → снижает будущие проценты', uz: 'Qo‘shimcha to‘lov asosiy qarzni kamaytiradi → kelajakdagi foizni pasaytiradi' },
    interactiveAction: 'compare-debts',
    teaser: { en: 'See how paying more than the minimum affects payoff timing and interest.', ru: 'Посмотрите, как доплаты влияют на срок погашения и проценты.', uz: 'Minimaldan ortiqroq to‘lov qarz muddatiga va foizga qanday ta’sir qilishini ko‘ring.' }
  },
  {
    id: 27,
    title: { en: 'Make Sure Extra Debt Payments Reduce Principal', ru: 'Убедитесь, что допплат уменьшают основной долг', uz: 'Qo‘shimcha to‘lovlar asosiy qarzni kamaytirishini ta’minlang' },
    category: 'Debt',
    isPro: true,
    shortDescription: { en: 'Confirm with your lender how extra payments are applied—principal reduction vs. advancing payments.', ru: 'Уточните у кредитора, как учитываются доплаты: уменьшают ли они основной долг или просто сдвигают график.', uz: 'Qo‘shimcha to‘lov kreditor tomonidan qanday hisoblanishini aniqlang: asosiy qarz kamayadimi yoki to‘lovlar oldinga siljiydimi.' },
    fullExplanation: { en: 'Some lenders may apply extra payments by moving the next due date forward instead of reducing principal. Ask how extras are applied so your payment actually shortens the loan and reduces interest when possible.', ru: 'Некоторые кредиторы могут использовать доплаты для сдвига следующего платежа, а не уменьшения основного долга. Спросите, как учитываются доплаты, чтобы они сокращали срок займа и проценты.', uz: 'Ba’zi kreditorlar qo‘shimcha to‘lovni keyingi to‘lovni oldinga surish uchun foydalanishi mumkin. Qo‘shimcha to‘lov qanday qo‘llanilishini so‘rang.' },
    example: { en: 'Ask: Will this extra payment be applied to principal or the next scheduled payment?', ru: 'Спросите: будет ли доплата зачтена в счёт основного долга или следующего платежа?', uz: 'So‘rang: bu qo‘shimcha to‘lov asosiy qarzga yoki keyingi rejalashtirilgan to‘lovga yoziladimi?' },
    whyItMatters: { en: 'Applied correctly, extras shorten the loan and reduce lifetime interest; applied incorrectly, they may not help.', ru: 'При правильном учёте доплаты сокращают срок кредита и уменьшают проценты; иначе — эффекта может не быть.', uz: 'To‘g‘ri qo‘llansa, qo‘shimchalar qarzni qisqartiradi; aks holda foydasi bo‘lmasligi mumkin.' },
    source: { en: 'Consumer Financial Protection Bureau', ru: 'Consumer Financial Protection Bureau', uz: 'Consumer Financial Protection Bureau' },
    formula: { en: 'Confirm application method with lender', ru: 'Уточните способ зачёта у кредитора', uz: 'Kreditor bilan qo‘llash usulini aniqlang' },
    interactiveAction: 'compare-debts',
    teaser: { en: 'Check how your lender applies extra payments before sending them.', ru: 'Проверьте у кредитора порядок учёта доплат до их перечисления.', uz: 'Qo‘shimcha to‘lovlarni jo‘natishdan oldin kreditor qanday hisoblashini tekshiring.' }
  },
  {
    id: 28,
    title: { en: 'Calculate the Long-Term Cost of Fees', ru: 'Рассчитайте долгосрочную стоимость комиссий', uz: 'Komissiyalarning uzoq muddatli xarajatini hisoblang' },
    category: 'Fees',
    isPro: true,
    shortDescription: { en: 'Ask how much a fee could cost over 10–20 years, not just whether it seems small.', ru: 'Спросите, во сколько обойдётся комиссия за 10–20 лет, а не только кажется ли она маленькой.', uz: 'Faqat kichikmi emas, balki 10–20 yil ichida qancha turishini ham hisoblang.' },
    fullExplanation: { en: 'Model fees over a long horizon to see their effect on final value. Reuse the same fee-impact calculation to compare scenarios with and without the fee rather than duplicating formulas.', ru: 'Смоделируйте комиссии за длительный период и сравните сценарии с комиссией и без неё, не дублируя формулы.', uz: 'Komissiyalarni uzoq muddat uchun modellashtiring va formulalarni takrorlamasdan farqni solishtiring.' },
    example: { en: 'Compare a 0.25% vs 1.00% fee over 20 years on the same investment to see the long-term difference.', ru: 'Сравните 0.25% и 1.00% за 20 лет на одинаковой сумме, чтобы увидеть разницу.', uz: 'Xuddi bir investitsiya uchun 20 yil davomida 0.25% va 1.00% ni solishtiring.' },
    whyItMatters: { en: 'Understanding long-term fee impact can help select lower-cost options when appropriate.', ru: 'Понимание долгосрочного влияния комиссий помогает выбирать более дешёвые варианты при необходимости.', uz: 'Uzoq muddatli komissiya ta’sirini bilish kerakli hollarda kamroq xarajatli variantlarni tanlashga yordam beradi.' },
    source: { en: 'Investor.gov', ru: 'Investor.gov', uz: 'Investor.gov' },
    formula: { en: 'Use shared fee-impact utility to compare net outcomes', ru: 'Используйте общую утилиту расчёта влияния комиссий для сравнения', uz: 'U umumiy komissiya ta’siri utilitasidan foydalanib natijalarni solishtiring' },
    interactiveAction: 'investment-fees',
    teaser: { en: 'Reuse the fee-impact calculator to compare long-term scenarios.', ru: 'Используйте калькулятор влияния комиссий для сравнения сценариев.', uz: 'Uzoq muddatli senariylarni solishtirish uchun komissiya kalkulyatoridan foydalaning.' }
  },
  {
    id: 29,
    title: { en: 'Avoid Concentration Risk', ru: 'Избегайте риска концентрации', uz: 'Konsentratsiya xavfidan saqlaning' },
    category: 'Investing',
    isPro: true,
    shortDescription: { en: 'Don’t put your entire portfolio in one asset, company, sector, or category.', ru: 'Не вкладывайте весь портфель в один актив, компанию или сектор.', uz: 'Butun portfelingizni bitta aktivga, kompaniyaga yoki sektorga joylashtirmang.' },
    fullExplanation: { en: 'Concentration increases vulnerability to a single outcome. Diversify across assets and categories to reduce single-asset shocks. This is educational guidance, not specific advice.', ru: 'Концентрация повышает уязвимость к одному исходу. Диверсифицируйте, чтобы снизить риск. Это образовательное руководство, а не персональная рекомендация.', uz: 'Konsentratsiya bitta natijaga qaramlikni oshiradi. Xatarni kamaytirish uchun aktivlar va toifalarni diversifikatsiya qiling.' },
    example: { en: 'If 80–90% of your portfolio is one stock, you face high concentration risk compared with a diversified mix.', ru: 'Если 80–90% портфеля — одна акция, риск концентрации намного выше по сравнению с диверсифицированным портфелем.', uz: 'Agar portfelingizning 80–90% bitta aksiyaga to‘g‘ri kelsa, diversifikatsiyalangan portfelga nisbatan yuqori konsentratsiya xavfi mavjud.' },
    whyItMatters: { en: 'Diversification reduces the chance that one event ruins your entire portfolio.', ru: 'Диверсификация снижает вероятность того, что одно событие уничтожит весь портфель.', uz: 'Diversifikatsiya bir voqea butun portfelingizni vayron qilish xavfini kamaytiradi.' },
    source: { en: 'FINRA / Investor.gov', ru: 'FINRA / Investor.gov', uz: 'FINRA / Investor.gov' },
    formula: { en: 'Compare current % vs target % per asset to identify concentration', ru: 'Сравните текущее% и целевое% для выявления концентрации', uz: 'Konzentratsiyani aniqlash uchun joriy% va maqsad% ni solishtiring' },
    interactiveAction: 'portfolio-concentration',
    teaser: { en: 'Check whether one holding dominates your portfolio.', ru: 'Проверьте, не доминирует ли один актив в вашем портфеле.', uz: 'Bir aktiv portfelingizda ustun emasligini tekshiring.' }
  },
  {
    id: 30,
    title: { en: 'Calculate Before You Buy', ru: 'Рассчитайте перед покупкой', uz: 'Xariddan oldin hisoblang' },
    category: 'Spending',
    isPro: true,
    shortDescription: { en: 'Before a big purchase, calculate price, working hours, income share, and potential delay to your goals.', ru: 'Перед крупной покупкой рассчитайте цену, рабочие часы, долю дохода и возможную задержку целей.', uz: 'Katta xariddan oldin narx, ish soatlari, daromad ulushi va maqsadlarni kechiktirishni hisoblang.' },
    fullExplanation: { en: 'For major purchases, consider: purchase price; how many working hours it costs (price ÷ net hourly pay); what percent of monthly income it represents; and how it could delay financial goals. Where possible, open related tools (Time to Freedom, Goals, What-If, calculators) to estimate impact.', ru: 'Для крупных покупок учтите: цену; сколько рабочих часов это стоит (цена ÷ почасовая оплата после налогов); какой процент месячного дохода; и как это может отложить финансовые цели. По возможности откройте соответствующие инструменты.', uz: 'Katta xaridlar uchun quydagilarni hisoblang: narx; necha ish soatiga teng (narx ÷ sof soatlik daromad); oylik daromad foizi; va bu moliyaviy maqsadlarni qanchalik kechiktirishi mumkin. Imkon bo‘lsa, Time to Freedom, Goals, What If va kalkulyatorlarni oching.' },
    example: { en: 'Purchase: 5,000,000 UZS. Monthly income: 5,000,000 UZS. Income share: 100%.', ru: 'Покупка: 5 000 000 UZS. Месячный доход: 5 000 000 UZS. Доля дохода: 100%.', uz: 'Xarid: 5,000,000 UZS. Oylik daromad: 5,000,000 UZS. Daromad ulushi: 100%.' },
    whyItMatters: { en: 'Calculating trade-offs helps avoid impulsive decisions and highlights cost in time and goal delay.', ru: 'Расчёты помогают избежать импульсивных решений и показывают стоимость в часах и задержке целей.', uz: 'Hisoblashlar impulsiv qarorlardan saqlaydi va xaridning vaqt va maqsadlarga ta’sirini ko‘rsatadi.' },
    source: { en: 'Practical budgeting guidance', ru: 'Практическое руководство по расходам', uz: 'Amaliy byudjet bo‘yicha ko‘rsatma' },
    formula: { en: 'Hours = price ÷ net hourly pay; Income% = price ÷ monthly income × 100', ru: 'Часы = цена ÷ почасовая оплата после налогов; % дохода = цена ÷ месячный доход × 100', uz: 'Soatlar = narx ÷ sof soatlik ish haqi; Daromad% = narx ÷ oylik daromad × 100' },
    interactiveAction: 'purchase-cost',
    teaser: { en: 'Translate big purchases into hours, income share, and goal delay.', ru: 'Переведите крупные покупки в часы, долю дохода и задержку целей.', uz: 'Katta xaridlarni soatlar, daromad ulushi va maqsad kechikishi sifatida baholang.' }
  }
]
